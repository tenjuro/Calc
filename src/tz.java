...
public class tz {
    ...
    public static void main(String[] args) throws IOException, ExceptionCalc {
        while (true){
    ...
    public static String calc(String input) throws IOException, ExceptionCalc {
        String[] result;
        int a = 0;
        if (input.contains("1")||input.contains("2")||input.contains("3")||input.contains("4")||input.contains("5")||input.contains("6")||input.contains("7")||input.contains("8")||input.contains("9")||input.contains("10")) {
            if (input.contains("+")) {
                ...
                throw new ExceptionCalc("Неизвестен операнд");
            }
//        } else if (input.contains("[I,II,III,IV,V,VI,VII,VIII,IX,X]")) {
    ...
    public static void Except(String stroka) throws IOException {
        int count = 0;
        ...
        if (count > 1){
            throw new IOException("Введено больше двух операндов");
        }
